...
public class TimerRunningColorGUI extends ATimerColorGui implements Listener, TimerGuiItems, Commands {

    public static final TimerRunningColorGUI INST = new TimerRunningColorGUI();
    ...
    public void inventoryClickHandler(ItemStack item, Player player) {
        if (ColorWoolUtils.isWool(item.getType())) {
            ...
            player.chat(TIMER_CMD + " color running " + colorName);
        }
    }
