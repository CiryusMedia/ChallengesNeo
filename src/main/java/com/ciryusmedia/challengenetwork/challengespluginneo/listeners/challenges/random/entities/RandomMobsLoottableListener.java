...
public class RandomMobsLoottableListener extends ARandomEntitiesDeath {
    ...
    public void handleRandomEntityDeathLogic(EntityDeathEvent event) {
        instance.reloadCustomConf(instance.getRandomMobsLoottableConfig(), instance.getRandomMobsLoottableConfigFile());
        ...
        event.getDrops().addAll((Collection<? extends ItemStack>) instance.getRandomMobsLoottableConfig().getList(event.getEntityType().name()));
